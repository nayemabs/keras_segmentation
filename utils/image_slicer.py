...
class ImageSlicer(object):
    ...
    def __read_images(self):
        ...
        for im in image_names:
            ...
            image = cv2.imread(str(dir_path)+im)
            Images.append(image)
        return Images
    ...
    def save_images(self,transformed, save_dir, img_name):
        # output_dir = '/home/vlad/Seagate/Research/GIS/ss-master/semantic-segmentation-master-super/data/data_road/source/gridded/'
        ...
        if not(os.path.exists(save_dir)):
            ...
            for key, val in transformed.items():
                ...
                for i, j in enumerate(val):
                    # plt.imsave(os.path.join(output_dir, img_name+'_'+str(i+1)+'.png'), j)
                    cv2.imwrite((save_dir+img_name+'_'+str(i+1)+'.png'), j)
                    # print("saved"
